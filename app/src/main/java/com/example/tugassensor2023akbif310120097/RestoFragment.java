...
import com.example.tugassensor2023akbif310120097.models.RestoModel;
import com.example.tugassensor2023akbif310120097.services.RestoService;
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    mMap.addMarker(new MarkerOptions().position(latLng).title("Lokasi Saya").snippet("Raka Fadlilah | 10120097").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW)));
